...
import { assetPath, dedent } from "@/lib/utils";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  ...
  return (
    <div className="space-y-4">
      ...
      {quizData.map((question, index) => (
        <div
          key={index}
          className={`border p-4 rounded-md ${userAnswers[index] === question.correctAnswer ? "bg-success/10" : "bg-destructive/10"}`}
        >
                ...
                return (
                  <div
                    ...
                    className={`w-full border border-border rounded-md p-4 text-wrap
                          ${
                            o_index === question.correctAnswer
                              ? "bg-success/20"
                              : o_index === userAnswers[index]
                                ? "bg-destructive/20"
                                : "bg-card"
                          }
                        `}
                ...
                <AccordionItem value="solution">
                  ...
                  <AccordionContent>
                    <div className="relative w-full my-2">
                      <Markdown>{dedent(question.solution)}</Markdown>
                    </div>
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
